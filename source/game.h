...
typedef struct {
    ...
    int   drifting;       /* always 0 as of v1.28.2 — the handbrake's
                           * drift mechanic was removed (see game.c's
                           * module comment); kept only so callers that
                           * still read it compile unchanged            */
